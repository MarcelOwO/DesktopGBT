...
if (!Crypt.DoesEnvironmentVariableExist("EncryptedApiKey"))
{
    ...
    Environment.SetEnvironmentVariable("EncryptedApiKey", Convert.ToBase64String(encryptedKey),
...
{
    var loadedEncryptedKey =
        Convert.FromBase64String(
            Environment.GetEnvironmentVariable("EncryptedApiKey", EnvironmentVariableTarget.User)!);
